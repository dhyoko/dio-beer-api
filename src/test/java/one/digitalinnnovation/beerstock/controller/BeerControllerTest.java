package one.digitalinnnovation.beerstock.controller;

import one.digitalinnnovation.beerstock.builder.BeerDTOBuilder;
import one.digitalinnovation.beerstock.controller.BeerController;
import one.digitalinnovation.beerstock.dto.BeerDTO;
import one.digitalinnovation.beerstock.dto.QuantityDTO;
import one.digitalinnovation.beerstock.exception.BeerNotFoundException;
import one.digitalinnovation.beerstock.exception.BeerStockExceededException;
import one.digitalinnovation.beerstock.exception.BeerStockLowerThanZeroException;
...
import static one.digitalinnnovation.beerstock.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    @Test
    void whenPOSTIsCalledWithoutRequestedFieldThenAnErrorIsReturned() throws Exception {
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETLISTIsCalledWithoutRegisteredBeerThenOkStatusIsReturned() throws Exception {
    ...
    @Test
    void whenDELETEIsCalledWithoutRegisteredNameThenNotFoundStatusIsReturned() throws Exception {
    ...
    @Test
    void whenPATCHIsCalledToDecrementToLowerThanZeroThenBadRequestIsReturned() throws Exception {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(30)
                .build();
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockLowerThanZeroException.class);
