package one.digitalinnnovation.beerstock.service;
...
public class BeerServiceTest {
    ...
    @InjectMocks
    private BeerService beerService; // insert the mocked beerRepository into service
    ...
    @Test
    void whenExclusionIsCalledWithoutRegisteredIdThenAnExceptionShouldBeThrow() {
        // when
